...
String City             = "Berlin";                    // Your home city See: http://bulk.openweathermap.org/sample/
...
const char* Timezone    = "MET-1METDST,M3.5.0/01,M10.5.0/02";  // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
